...
process_create.o: ${S}/main/process_create.c
	${COMPILE.c} ${S}/main/process_create.c
SRCS+=${S}/main/process_create.c
OBJS+=process_create.o
...
mem.o: ${S}/userprog/mem.c
	${COMPILE.c} ${S}/userprog/mem.c
SRCS+=${S}/userprog/mem.c
OBJS+=mem.o
